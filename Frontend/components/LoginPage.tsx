    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-green-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl text-gray-900 mb-2">WealthGenie</h1>
          <p className="text-gray-600">Track. Analyze. Improve your finances.</p>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              <Button
                onClick={onLogin}
                className="w-full h-12 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 hover:text-gray-900 shadow-sm"
              >
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600">Improve Finances</p>
          </div>
        </div>
      </div>
    </div>
